...
public class Restorant_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView1 = findViewById(R.id.recyclerview_restorant);
        ...
        //서버주소
        String serverUrl = "http://heremong.dothome.co.kr/SearchFood.php";
